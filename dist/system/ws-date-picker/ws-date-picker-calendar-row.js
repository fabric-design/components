System.register(['../imports', 'moment'], function (_export, _context) {
	"use strict";

	var React, Component, moment, _createClass, WSDatePickerCalendarWeek, WSDatePickerWeekDay;
	...
	return {
		...
		execute: function () {
			...
			_export('WSDatePickerCalendarWeek', WSDatePickerCalendarWeek = function (_Component) {
			...
			_export('WSDatePickerCalendarWeek', WSDatePickerCalendarWeek);

			WSDatePickerWeekDay = function (_Component2) {
