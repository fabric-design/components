System.register(['../imports', './ws-dropdown'], function (_export, _context) {
  "use strict";

  var React, WSDropdown, _createClass, WSDropdownInput;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('WSDropdownInput', WSDropdownInput = function (_WSDropdown) {
      ...
      _export('WSDropdownInput', WSDropdownInput);
