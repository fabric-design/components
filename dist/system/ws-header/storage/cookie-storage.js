System.register(['./abstract-storage'], function (_export, _context) {
  ...
  var AbstractStorage, _createClass, EXTRACT_TOP_LEVEL_DOMAIN, CookieStorage;
  ...
  return {
    ...
    execute: function () {
      ...
      EXTRACT_TOP_LEVEL_DOMAIN = /.*?([a-zA-Z0-9-]{3,}\.[a-zA-Z0-9]{2,})$/;

      _export('CookieStorage', CookieStorage = function (_AbstractStorage) {
