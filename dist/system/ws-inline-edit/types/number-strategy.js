System.register(['./abstract-type-strategy'], function (_export, _context) {
  "use strict";

  var AbstractTypeStrategy, _createClass, english, german, strip, NumberStrategy;
  ...
  return {
    setters: [function (_abstractTypeStrategy) {
      AbstractTypeStrategy = _abstractTypeStrategy.AbstractTypeStrategy;
    }],
    execute: function () {
      ...
      english = '([0-9]*(,[0-9]{3})*)(\\.[0-9]+)?';
      german = '([0-9]*(\\.[0-9]{3})*)(,[0-9]+)?';

      strip = function strip(str) {
        return str.replace(/[.,]/g, '');
      };

      _export('NumberStrategy', NumberStrategy = function (_AbstractTypeStrategy) {
