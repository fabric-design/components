System.register(['./abstract-type-strategy'], function (_export, _context) {
  ...
  var AbstractTypeStrategy, _createClass, english, german, strip, PriceStrategy;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('PriceStrategy', PriceStrategy = function (_AbstractTypeStrategy) {
      ...
      _export('PriceStrategy', PriceStrategy);
    }
  };
});