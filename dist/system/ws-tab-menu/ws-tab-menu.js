System.register(['../imports'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export('WSTabMenu', WSTabMenu = function (_Component) {
        ...
        _createClass(WSTabMenu, [{
          ...
          value: function renderMenuItem(item, index) {
            ...
            return React.createElement(
              ...
              item.badge !== undefined && React.createElement(
                'span',
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'dash-bar' },
                React.createElement('div', { className: 'dash', ref: function ref(element) {
                    _this6.dash = element;
                  } })
              )
            );
