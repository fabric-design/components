System.register(['../imports', './ws-week-picker-calendar', './ws-week-picker.scss'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export('WSWeekPicker', WSWeekPicker = function (_Component) {
        ...
        _createClass(WSWeekPicker, [{
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement('i', { className: 'icon icon-' + (this.state.show ? 'cross' : 'calendar') + ' icon16',
                onClick: function onClick() {
                  return _this3.toggleCalendar();
                }
              }),
      ...
      _export('WSWeekPicker', WSWeekPicker);
